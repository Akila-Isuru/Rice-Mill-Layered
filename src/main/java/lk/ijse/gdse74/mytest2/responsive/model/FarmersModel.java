...
public class FarmersModel {
    public ArrayList<FarmerDTO> viewAllFarmers()throws ClassNotFoundException, SQLException {
        ResultSet rs = CrudUtill.execute("select * from farmers");
        ArrayList<FarmerDTO> farmers = new ArrayList<>();
        while (rs.next()) {
    ...
    public boolean saveFarmer(FarmerDTO farmersdto)throws ClassNotFoundException, SQLException {
    ...
    public boolean deleteFarmer(FarmerDTO farmersdto) throws SQLException {
        String sql = "delete from farmers where farmer_id=?";
        return CrudUtill.execute(sql,farmersdto.getFarmerId());
    }

    public boolean updateFarmer(FarmerDTO farmersdto) throws SQLException {
        return CrudUtill.execute(
